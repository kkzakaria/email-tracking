                    ...
                    <NavigationMenuItem key={link.href}>
                      <NavigationMenuLink asChild>
                        <Link 
                          ...
                          className={cn(
                            isActive 
                              ? "bg-blue-700 text-white hover:bg-blue-800 h-9 px-4 py-2 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" 
                              : navigationMenuTriggerStyle(),
