...
export async function getEmailTrackings(): Promise<EmailTracking[]> {
  const supabase = await createClient()
...
export async function getEmailTrackingById(id: string): Promise<EmailTracking | null> {
  const supabase = await createClient()
...
export async function updateEmailTracking(id: string, data: EmailTrackingUpdate): Promise<EmailTracking> {
  const supabase = await createClient()
...
export async function deleteEmailTracking(id: string): Promise<void> {
  const supabase = await createClient()
